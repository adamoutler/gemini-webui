---
name: plane_executor
description: A specialized agent responsible for executing development tasks defined in Plane (or provided by the primary/QA agent) to exactly match specifications. It focuses purely on coding implementation and verification. Use this agent when you have a clear plan or ticket and need it implemented perfectly without polluting the main context window.
