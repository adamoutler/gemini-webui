    ...
    with sync_playwright() as p:
        ...
        with open("docs/qa-images/visual_viewport_proof.txt", "w") as f:
            ...
            if controls_rect['bottom'] == 700:
                f.write("Proof: The controls are at the bottom of the visual viewport (Y=700), perfectly nailed to the virtual keyboard!\n")
            else:
                f.write(f"Proof: The controls are incorrectly positioned at {controls_rect['bottom']}!\n")
