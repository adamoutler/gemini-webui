...
def main():
    ...
    try:
        ...
        with sync_playwright() as p:
            ...
            assert "Login" in title or "Gemini" in title or page.locator("body").is_visible(), "Page did not load properly"
            
            screenshot_path_1 = 'docs/qa-images/fresh_container_splash.png'
            page.screenshot(path=screenshot_path_1, full_page=True)
            shutil.copy(screenshot_path_1, os.path.join(proof_dir, 'fresh_container_splash.png'))
    ...
    try:
        ...
        with sync_playwright() as p:
            ...
            shutil.copy(screenshot_path_2, os.path.join(proof_dir, 'ssh_session_no_gemini.png'))
