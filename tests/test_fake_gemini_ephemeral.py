...
def test_fake_gemini_ephemeral(page, server):
    ...
    page.screenshot(path="/tmp/launcher_page.png")
    print("Saved screenshot to /tmp/launcher_page.png")
    ...
    page.screenshot(path="/tmp/active_fake_session.png")
    print("Saved screenshot to /tmp/active_fake_session.png")
    ...
    page.screenshot(path="/tmp/friction_modal_after_reload.png")
    print("Saved screenshot to /tmp/friction_modal_after_reload.png")
    ...
    with page.context.new_page() as second_page:
        ...
        second_page.screenshot(path="/tmp/backend_rejection.png")
        print("Saved screenshot to /tmp/backend_rejection.png")
