...
const { MobileInputBuffer, MobileInputUI } = require('../src/static/mobile_input.js');

let emitted = [];
let buffer = new MobileInputBuffer((data) => emitted.push(data), true, null);
let ui = new MobileInputUI('test', buffer.handleInput.bind(buffer), buffer.handleKeyDown.bind(buffer));
