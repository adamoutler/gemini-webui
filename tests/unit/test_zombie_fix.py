...
class TestZombieFix(unittest.TestCase):
    ...
    def test_session_manager_replaces_and_kills_old_pid(self):
        ...
        with (
            patch("src.services.session_store.os.killpg") as mock_killpg,
            patch("src.services.session_store.os.getpgid") as mock_getpgid,
            patch("src.services.session_store.os.close") as mock_close,
